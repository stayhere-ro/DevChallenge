                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/new-booking">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <label class="form-label text-muted small">Booking for:</label>
                                    <p class="h5"><strong>{{ Auth::user()->name }}</strong></p>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted small">Confirmation email:</label>
